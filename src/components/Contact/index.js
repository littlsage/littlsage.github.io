    ...
    <>
      <div className="container contact-page">
        ...
        <div className="map-wrap">
          <MapContainer center={[41.2994958, 69.24007340000003]} zoom={13}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[41.2994958, 69.24007340000003]}>
              <Popup>S@ge lives here, come over for a cup of coffee :)</Popup>
            </Marker>
          </MapContainer>
        </div> */}
      </div>
